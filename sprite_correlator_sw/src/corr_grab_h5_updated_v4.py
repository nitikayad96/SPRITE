...
sys.path.append('/home/sprite/nitika/loberotator')
from update_phi_rate_test import calc_phi_step, calc_rp_error # fringe stopping
...
if __name__ == '__main__':
    ...
    print('Actual rate: ',actual_phi_rate)
